...
public class casestudyI {
	...
	@When("user enters username as {string} in username")
	public void user_enters_username_as_in_username(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new cucumber.api.PendingException();
	}

	@When("user enters firstname as {string} in firstname field")
	public void user_enters_firstname_as_in_firstname_field(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new cucumber.api.PendingException();
	}

	@When("user enters lastname as {string} in lastname field")
	public void user_enters_lastname_as_in_lastname_field(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new cucumber.api.PendingException();
	}

	@When("user enters Password as {string} in password field")
	public void user_enters_Password_as_in_password_field(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new cucumber.api.PendingException();
	}

	@When("user enters confirm password as {string} in confirm password field")
	public void user_enters_confirm_password_as_in_confirm_password_field(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new cucumber.api.PendingException();
	}
	...
	public void user_enters_email_as_in_email_field(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new cucumber.api.PendingException();
	}

	@When("user enters mobile number as {string} in mobile number")
	public void user_enters_mobile_number_as_in_mobile_number(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new cucumber.api.PendingException();
	}

	@When("user enters DOB as {string} in DOB")
	public void user_enters_DOB_as_in_DOB(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new cucumber.api.PendingException();
	}

	@When("user enters address as {string} in address")
	public void user_enters_address_as_in_address(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new cucumber.api.PendingException();
	}

	@When("user enters security question as {string} in security question")
	public void user_enters_security_question_as_in_security_question(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new cucumber.api.PendingException();
	}

	@When("user enters answer as {string} in answer")
	public void user_enters_answer_as_in_answer(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new cucumber.api.PendingException();
	}
	...
	@Given("user launches browser And navigates to application url")
	public void user_launches_browser_And_navigates_to_application_url() {
	    System.setProperty("webdriver.chrome.driver", "C:\\NexGen Testing Stream\\Drivers\\chromedriver_win32.exe");
